...
func (s *OpsSuite) TestEnsureScaleAlive(c *tc.C) {
	...
	err := caasapplicationprovisioner.AppOps.EnsureScale(c.Context(), "test", appId, app, life.Alive, "stateful", facade, applicationService, statusService, s.logger)
	c.Assert(err, tc.ErrorIsNil)
}
...
func (s *OpsSuite) TestEnsureScaleDyingDead(c *tc.C) {
	...
	err := caasapplicationprovisioner.AppOps.EnsureScale(c.Context(), "test", appId, app, life.Dead, "stateful", facade, applicationService, statusService, s.logger)
	c.Assert(err, tc.ErrorIsNil)
}
...
func (s *OpsSuite) TestEnsureScaleWithAttachStorage(c *tc.C) {
	...
	err := caasapplicationprovisioner.AppOps.EnsureScale(c.Context(), "test", appUUID, app, life.Alive, "stateful", facade, applicationService, statusService, s.logger)
	c.Assert(err, tc.ErrorIsNil)
}
...
func (s *OpsSuite) TestEnsureScaleDownDeployment(c *tc.C) {
	...
	err := caasapplicationprovisioner.AppOps.EnsureScale(c.Context(), "test", appUUID, app, life.Alive, "stateless", facade, applicationService, statusService, s.logger)
	c.Assert(err, tc.ErrorIsNil)
}
...
func (s *OpsSuite) TestEnsureScaleDownDaemonSet(c *tc.C) {
	...
	err := caasapplicationprovisioner.AppOps.EnsureScale(c.Context(), "test", appUUID, app, life.Alive, "daemon", facade, applicationService, statusService, s.logger)
	c.Assert(err, tc.ErrorIsNil)
}
